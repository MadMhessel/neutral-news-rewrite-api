...
6) Верни строго один JSON-объект. Никакого Markdown. Начни с {{ и закончи }}.
7) Ограничения длины: title до 120 символов; summary 350–600 символов; text 1500–2500 символов (не больше); tags 5–10 коротких тегов; image_prompt 250–500 символов.
8) Если исходный текст длинный — сжимай, а не увеличивай.
...
{{
  "title": "короткий заголовок до 120 символов",
  "text": "полный текст новости 1500–2500 символов, абзацы разделяй \n\n",
  "summary": "1–2 предложения 350–600 символов",
  "tags": ["5–10 коротких тегов, без решёток"],
  ...
  "image_prompt": "краткое описание изображения 250–500 символов, без текста на картинке, фотореализм"
}}
"""
